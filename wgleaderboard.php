...
$stmt = $pdo->prepare("SELECT username, score, timestamp FROM leaderboard WHERE game = 'wordguess' ORDER BY score DESC");
$stmt->execute();
    ...
    <div class="login-box">
      ...
      <table style="width:100%; border-collapse: collapse; margin-top:20px;">
        ...
        <tr>
          ...
          <td style="padding:10px; border:1px solid #999;"><?php echo $row['score']; ?></td>        </tr>
        <?php endforeach; ?>
      </table>
